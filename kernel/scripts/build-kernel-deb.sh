...
DEB_DIR="linux-kernel-debug-$PKG_KERNEL_VERSION-arm64"
...
Package: linux-kernel-debug-$PKG_KERNEL_VERSION
...
existing_kernel_package="linux-kernel-debug-\$kernel_version"
