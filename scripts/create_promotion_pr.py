...
def parse_arguments():
    ...
    parser.add_argument("--pr-branch",
                        required=False,
                        default=None,
                        help="Promotion branch to open as the PR head.")
...
def create_pr_body(base_branch: str, upstream_tag: str, normalized_version: str, promoted_upstream_tag: str, pr_branch: str) -> str:
    return f"""
...
def main():
    ...
    pr_branch = args.pr_branch if args.pr_branch else f"debian/pr/{args.normalized_version}-1"
    pr_title = create_pr_title(args.normalized_version)
    pr_body = create_pr_body(
        args.base_branch,
        args.upstream_tag,
        args.normalized_version,
    ...
    pr_creation_command = (
        ...
        f"--base {args.base_branch} --head {pr_branch}"
    )
