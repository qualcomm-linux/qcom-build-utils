...
def create_pr_body(base_branch: str, upstream_tag: str, normalized_version: str, promotion_version: str, promoted_upstream_tag: str) -> str:
    return f"""
...
- PR branch: `debian/pr/{promotion_version}`
...
gitGraph BT:
  ...
  commit
  commit
  branch debian/pr/{promotion_version} order: 2
...
def main():
    ...
    pr_body = create_pr_body(args.base_branch, args.upstream_tag, args.normalized_version, args.promotion_version, args.promoted_upstream_tag)
    ...
    pr_creation_command = f"gh pr create --title '{pr_title}' --body-file promotion_pr_body.md --base {args.base_branch} --head debian/pr/{args.promotion_version}"
